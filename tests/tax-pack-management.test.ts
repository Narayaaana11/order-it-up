...
async function main() {
  ...
  try {
    ...
    const zeroPluginReceipt = escPosToText(formatReceipt(
      ...
      { name: 'OTU Test Cafe', country: 'IN', currency_symbol: '₹', show_tax_breakdown: false },
      'in.gst.tax-invoice.v1',
      48,
      true,
    ));
    ...
    const exactWidthReceipt = escPosToText(formatReceipt(
      ...
      { name: 'OTU Test Cafe', country: 'IN', currency_symbol: '₹', show_tax_breakdown: true },
      'in.gst.tax-invoice.v1',
      42,
      true,
      false,
    ...
    const fallbackReceipt = escPosToText(formatReceipt(
      ...
      { name: 'OTU Test Cafe', country: 'IN', currency_symbol: '₹' },
      'in.gst.tax-invoice.v1',
      48,
      true,
    ));
