#!/usr/bin/env node
// Prepends a <release> entry to assets/com.orderitup.pos.metainfo.xml at release
...
const META_FILE = path.join(ROOT, 'assets/com.orderitup.pos.metainfo.xml');
